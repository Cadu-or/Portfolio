...
export function Ferramentas(){
  return(
		<div className="mt-28">
			...
			<div className="grid grid-cols-2 gap-4 p-6 xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4">
				...
				<Simbolo simbolo="devicon-mysql-plain" texto="MySQL" trabalhando={true} estudando={false}/>
				...
				<div className="flex flex-col items-center border-zinc-400 p-4 rounded-lg border-2 h-44 justify-center">
